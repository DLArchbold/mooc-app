...
import StudnetsDataService from '../../api/feedback/StudentsDataService.js'
...
class ListStudentsComponent extends Component {
    ...
    filterStudentsByInterest(values){
        StudnetsDataService.retrieveAllStudentsForInterest(values.lesson)
        .then(
            response => {
                this.setState({ students: response.data })
            }
